...
namespace StackExchange.DataExplorer.Models
{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Revisions")]
    ...
    partial void OnCreationDateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_OwnerIP", DbType="VarChar(15) NOT NULL", CanBeNull=false)]
		public string OwnerIP
		{
			get
			{
				return this._OwnerIP;
			}
			set
			{
				if ((this._OwnerIP != value))
				{
					this.OnOwnerIPChanging(value);
					this.SendPropertyChanging();
					this._OwnerIP = value;
					this.SendPropertyChanged("OwnerIP");
					this.OnOwnerIPChanged();
				}
			}
		}
