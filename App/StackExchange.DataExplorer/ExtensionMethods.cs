...
namespace StackExchange.DataExplorer
{
    public static class ExtensionMethods
    {
        ...
        /// </summary>
        public static IEnumerable<Dictionary<string, object>> ExecuteQuery(this DBContext ctx, string query)
        {
        ...
        /// </summary>
        public static IEnumerable<Dictionary<string, object>> ExecuteQuery(this DBContext db, string query,
        ...
        {
            PropertyInfo[] props = parameterHash.GetType().GetProperties();
            ...
            for (int i = 0; i < props.Length; i++)
            {
                ...
                object value = prop.GetValue(parameterHash, null);
        ...
        public static IEnumerable<object[]> ExecuteQueryArray(this DBContext ctx, string query)
        {
        ...
        public static IEnumerable<object[]> ExecuteQueryArray(this DBContext ctx, string query, object parameterHash)
        {
            using (DbCommand cmd = ctx.Connection.CreateCommand())
            {
                ...
                using (DbDataReader rdr = cmd.ExecuteReader(CommandBehavior.CloseConnection))
                {
                    while (rdr.Read())
                    {
                        var res = new object[rdr.FieldCount];
                        rdr.GetValues(res);
                        yield return res;
                    }
                }
